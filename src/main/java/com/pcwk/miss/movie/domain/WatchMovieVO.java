...
* Class Name : WatchMovieVO.java
* Description: screen.jsp 영화상영 유튜브 URL 가져오기
* Author: ITSC
* Since: 2022/06/20
* Version 0.1
...
public class WatchMovieVO extends DTO{
...
public WatchMovieVO() {
	...
	public WatchMovieVO(int mvNum, String miTime, int miQuality, String miVideo) {
		super();
		this.mvNum = mvNum;
		this.miTime = miTime;
