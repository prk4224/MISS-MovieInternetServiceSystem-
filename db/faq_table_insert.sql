...
INSERT INTO FAQ (Q_NUM,Q_KIND,Q_TITLE,Q_CONTENTS,Q_DATE)
VALUES(q_num_seq.NEXTVAL,1,'[시스템점검] 2022년 5월 시스템 점검 안내',' 안녕하십니까, MISS입니다. <br>원활하고 안정된 서비스 제공을 위하여 2022년 5월 새벽 시스템 점검 작업이예정되어 있습니다.  점검 시간 중 MISS홈페이지의 모든 서비스가 중단될 예정이오니 이용에 불편 없으시기바랍니다.  <br><br>1. 일시   - 6/28 02시 ~ 07시 <br>2. 내용 <br>- 정기 M작업(시스템 성능 개선 작업) <br>- 작업 대상 : 극장영업시스템, 온라인 서비스(홈페이지모바일) <br>더욱 안정적이고 편리한 서비스를 제공하는 MISS가 되겠습니다.   감사합니다.','20220627')_;
INSERT INTO FAQ (Q_NUM,Q_KIND,Q_TITLE,Q_CONTENTS,Q_DATE)
